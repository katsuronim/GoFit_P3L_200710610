...
class ReadHistoryGymActivity : AppCompatActivity() {
    private lateinit var binding : ActivityReadHistoryGymBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityReadHistoryGymBinding.inflate(layoutInflater)
    ...
    fun showDataFragment(idUser: String, nama: String, tglMulai: String, tglAkhir: String) {
        ...
        val mFragment = DataHistoryGymFragment()
        val mBundle = Bundle()
