...
class ReadBookingPaketActivity : AppCompatActivity() {
    private lateinit var binding : ActivityReadBookingPaketBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityReadBookingPaketBinding.inflate(layoutInflater)
