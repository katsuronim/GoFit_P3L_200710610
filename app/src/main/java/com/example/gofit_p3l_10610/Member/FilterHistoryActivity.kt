...
class FilterHistoryActivity : AppCompatActivity() {
    private lateinit var binding : ActivityFilterHistoryBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityFilterHistoryBinding.inflate(layoutInflater)
        ...
        binding.btnGenerate.setOnClickListener{
            ...
            val intent = Intent(this@FilterHistoryActivity, ReadHistoryKelasActivity::class.java)
